...
import config, {telegramLink, tokenCA, twitterLink } from "@/config";
  ...
  return (
    <>
      ...
      <nav
        ...
        } w-screen z-[9999] transition-all mt-[107px] space-y-5 px-6 py-5 ease-in-out duration-200 fixed top-0 right-0 bg-yellow-50 h-full`}
      >
        <Link
          href="/"
            ...
            {config.homeMainSection.buttons.map(
              (button: Button, index: number) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-semibold px-3 text-center w-[55%] border border-[#9e782c] shadow-[2px_2px_0_#9e782c] active:shadow-[0.5px_0.5px_0_#9e782c] active:translate-x-[1px] active:translate-y-[1px] text-blue-950 active:scale-[0.99] transition-all ease-linear duration-100 hover:bg-yellow-500/80 active:bg-yellow-500/90 bg-yellow-500/70 py-[8.95px] rounded-xl"
                >
                  {button.text}
                </a>
              )
      ...
      <nav className="h-[40px] z-[9997] flex w-full top-0 fixed lg:hidden text-amber-200 border-b-2 border-amber-200 font-medium items-center justify-center bg-blue-950">
        <TextScroller />
      </nav>
      <motion.div
      ...
      >
        <header className="fixed z-[9998] grid lg:mt-0 mt-[40px] px-5 grid-cols-2 md:grid-cols-3 grid-rows-1 top-0 left-0 right-0 w-full h-[68px] bg-amber-50 border-b-2 border-zinc-800">
          ...
          <div className="w-full flex lg:hidden flex-row items-center justify-end">
            <button
              ...
              className="hover:bg-blue-950 p-[10px] active:bg-blue-950 bg-blue-950 rounded-xl active:scale-[0.98] transition-all ease-linear duration-100"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
        ...
        <nav className="h-[40px] mt-[68px] w-full hidden lg:flex text-amber-200 border-b-2 border-amber-200 font-medium items-center justify-center bg-blue-950">
          <TextScroller />
        </nav>
      </motion.div>
    </>
